...
<li class="dropdown">
                ...
                <li class="active"><a href="data-order.php"><span class="glyphicon glyphicon-credit-card list-group-item-warning"></span> Order/Pembelian</a></li>
              </a></li></ul>
...
<div class="col-md-10">
	</div><center><h1> Data Order</h1></center><br><br>
<div class="col-md-8 list-group-item-warning">

<?php

if(@$_GET['pesan']=="inputOrderBerhasil"){
?>

<div class="alert alert-success">
  penyimpanan 1 Data Order berhasil
</div>
...
if(@$_GET['pesan']=="hapusOrderBerhasil"){
?>

<div class="alert alert-success">
  1 Data Order berhasil dihapus!
</div>
...
if(@$_GET['pesan']=="editOrderBerhasil"){
?>
...
?>
    ...
    <thead>
    <tr><center>
      <td><center><b>Kode Order</b></center>
    ...
    include"koneksi.php";
$sql=$koneksi->query("select * from dt_order order by id_order ASC");
...
while($row= $sql->fetch_assoc()){
  ...
  <tr>
      ...
      <td>
             ...
             <a href="edit-order.php?id=<?php echo $row['id_order']?>">
                    <button class="btn btn-xs btn-danger glyphicon glyphicon-edit"> </button>

                </a>

                 <a href="hapus-order.php?id=<?php echo $row['id_order']?>" onclick="return confirm('anda yakin menghapus data?')">
